...
const GwaliorCity = () => {
  ...
  const venues = [
    {
      image: img1,
      venue: "CentralPark Hotel",
      rating: "4.5",
      address:
        "Madhav Rao Scindia Marg, opp. Vishal Mega mart, City Center, Mahalgaon, Gwalior, Madhya Pradesh 474001",
    },
    {
      image: img2,
      venue: "Royelinn Hotel",
      rating: "5.0",
      address:
        "Hotel, Nagar Nigam, 5, Main Rd, City Center, Patel Nagar, Gwalior, Madhya Pradesh 474011",
    },
    {
      image: img3,
      venue: "Tansan Hotel",
      rating: "4.3",
      address:
        "6-A, Gandhi Rd, LNUPE Campus, Thatipur, Gwalior, Madhya Pradesh 474002",
    },
    {
      image: img4,
      venue: "UshaTaj Hotel",
      rating: "3.9",
      address:
        "near Saraswati Shishu Mandir, Jayendraganj, Lashkar, Gwalior, Madhya Pradesh 474009",
    },
  ];
    ...
    <div className="bhopal-page">
      ...
      <div className="venue-header text-white">
        <div className="container">
          <h1>Book Top Venues In Gwalior</h1>
          <p className="text-capitalize text-white">
            Looking To Book The Best Venues In GwaliorCity for your Next Event?
