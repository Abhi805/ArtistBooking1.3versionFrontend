  ...
  const venues = [
    {
      ...
      rating: "4.5",
      address:
        "3687/1 Near over bridge Hari Phatak indore road, imperial square, Ujjain, Madhya Pradesh 456010",
    },
    {
      image: img2,
      venue: "mittalevenue",
      rating: "5.0",
      address:
        "Ring Road, near CHL Hospital, Nanakheda, Rishi Nagar, Ujjain, Sawara Khedi, Madhya Pradesh 456010",
    },
    {
      image: img3,
      venue: "mpt",
      rating: "4.3",
      address:
        "University Road Infront Of, Madhav Club Rd, Ujjain, Madhya Pradesh 456010•0734 255 5687",
    },
    {
      image: img4,
      venue: "solitarehotel",
      rating: "3.9",
      address:
        "Chintaman Road, Jaysinghpura, near Jantar Mantar, infront of Gyan Sagar Girls Academy, Ujjain, Madhya Pradesh 456001",
    },
    {
      image: img5,
      venue: "vikramaditya",
      rating: "4.0",
      address: "81/1, chouraha, near, Ring Road, Ujjain, Madhya Pradesh 456001",
    },
  ];
    ...
    <div className="indore-page">
      ...
      <div className="venue-header text-white">
        <div className="container">
          <h1>Book Top Venues In Ujjain</h1>
          <p className="text-capitalize text-white">
            Looking To Book The Best Venues In UjjainCity for your Next Event?
